...
{
    public partial class CH_CaseSettingUserControl : ChungHsin_Field4UserControl
    {
        ...
        private void AddsimpleButton_Click(object sender, EventArgs e)
        {
            if (!FlyoutFlag)
            {
                ...
                CH_CaseSettingUserControl1 CaseSettingUserControl = new CH_CaseSettingUserControl1(this, Form1, ChungHsin_MySqlMethod);
